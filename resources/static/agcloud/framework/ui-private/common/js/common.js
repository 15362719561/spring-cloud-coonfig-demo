...
var sricptObjdds=document.getElementsByTagName("script");
var oooBJ=sricptObjdds[sricptObjdds.length-1];
var srcDDD=oooBJ.getAttribute("src").split("/agcloud/")[0];
var JSElementOBJDDDD1=document.createElement("script");
JSElementOBJDDDD1.setAttribute("type","text/javascript");
JSElementOBJDDDD1.setAttribute("src",srcDDD+"/agsupport/map/js/interact/interact.min-v1.6.2.js");
document.body.appendChild(JSElementOBJDDDD1);
setTimeout(function(){
    var  JSElementOBJDDDD2=document.createElement("script");
    JSElementOBJDDDD2.setAttribute("type","text/javascript");
    JSElementOBJDDDD2.setAttribute("src",srcDDD+"/agsupport/map/js/interact/common.js");
    document.body.appendChild(JSElementOBJDDDD2);
},1000);